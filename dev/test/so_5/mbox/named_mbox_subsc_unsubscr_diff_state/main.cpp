/*
	...
	Суть теста:
		...
		Агент подписывается на несколько сообщений для различных состояний
		от именованного mbox-а,
		...
		получаемого mbox-а.
		Далее агент переходит по всем состояниям,
		предварительно отписываясь от сообщения в данном состоянии,
		в итоге должен дойти до состояния shutdown и завершить работу.
*/
