...
class naive_cond_var_t
	{
	private :
		naive_mutex_t & m_mutex;
...
class demand_queue_t
{
	...
	private:
		...
		naive_mutex_t m_lock;
		naive_cond_var_t m_not_empty;
...
demand_queue_t::push(
	...
	void * param )
{
	ACE_Guard< naive_mutex_t > lock( m_lock );
